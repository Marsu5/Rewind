...
public class h extends MyScreen {
    ...
    public void init() {
        super.init();
        stage = new DontLookAtThisThisIsEasterEgg(new ExtendViewport(Globals.WORLD_WIDTH,Globals.WORLD_HEIGHT,new OrthographicCamera(Globals.WORLD_WIDTH,Globals.WORLD_HEIGHT)),new SpriteBatch(),game);
